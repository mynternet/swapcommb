...
dependencies:
  ...
  apollo-server-express:
    specifier: ^3.12.1
    version: 3.12.1(express@4.18.2)(graphql@16.8.1)
  bcrypt:
    specifier: ^5.1.1
    version: 5.1.1
  card-validator:
...
packages:
  ...
  /apollo-server-express@3.12.1(express@4.18.2)(graphql@16.8.1):
    resolution: {integrity: sha512-5A9efrhEXqDx08BnORWf0zPYCABENqur47VZZW8osQpSSnMINqzJiV5RMrzz8wIznecRRhEcz+BqLdiexqZdgg==}
    engines: {node: '>=12.0'}
  ...
  /graphql-upload@16.0.2(graphql@16.8.1):
    resolution: {integrity: sha512-enwIkZqUELdNH9lrjHlTNfj7gLitSa0EAX4TNXZtg2frnmQzPhpjH0l+6K7ft274fhoRCIcz8SKiNRJDf/cG4Q==}
